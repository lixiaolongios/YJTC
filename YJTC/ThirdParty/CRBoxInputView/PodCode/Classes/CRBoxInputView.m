...
- (UICollectionViewCell *)customCollectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (self.type) {
        case 1000://登录样式
        {
            cell.customImage.backgroundColor = HEX_COLOR_ALPHA(0xFFFFFF, 0.1);
          //  [cell.customImage layoutCornerRadiusWithCornerRadius:10];
        }
            
            break;
            
        default:
            [cell.customImage setImage:[UIImage imageNamed:@"room_password_text_bg"]];
            break;
    }
    return cell;
}
...
- (CRBoxFlowLayout *)boxFlowLayout
{
    if (!_boxFlowLayout) {
        ...
        _boxFlowLayout.itemSize = CGSizeMake(54, 48);
    }
