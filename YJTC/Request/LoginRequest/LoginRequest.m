...
- (Class)modelClass
{
    ...
    return <#expression#>;
    switch (_type) {
        case RoomApiType_Room_Create://创建房间
        case ThemeCornerInfo://主题详情
            return [ComRoomModel class]; 
            break;
        case RoomApiType_EnterRoom://进入房间
        case RoomApiType_roomInfo://房间信息
            return [RoomModel class];
            break;
        case RoomApiType_Room_List://房间列表
        case ThemeCornerList:
            return [ComRoomSetModel class];
            break;
            
        case RoomApiType_Room_BackGround://创建房间背景图列表
            return [LiveBgComModel class];
            break;
            
        case RoomApiType_Room_BatchQueryRoom: //批量查询房间信息
        {
            return [RoomSetModel class];
        }
            break;
        case RoomApiType_Room_ConnectorList: //房间连麦和排麦列表
        case RoomApiType_CrossRoom_ConnectorList:  //跨房连麦列表
        {
            return [VideoConnectModel class];
        }
            break;
        case RoomApiType_RoomConfig:  //emoji
        {
            return [EmojiModelSet class];
        }
            break;
            
        case RoomUserAssetRoomCardStatus:
        case RoomUserAssetRoomCardStatus_: //房间创建前和进行中 用户房卡道具状态
        case RoomDurationRenewBefore: // 房间续时前 房卡或钻石
        case RoomDurationRenew: // 房间续时 房卡或钻石:  //emoji
        {
            return [RoomCardSetModel class];
        }
            break;
        case RoomApiType_roomProfile:  //
        {
            return [ComSubModel class];
        }
            break;
        case RoomApiType_Room_Tag_List:  //
        {
            return [LiveBgSetModel class];
        }
            break;
        case PairRoomCloseResult:  //
        case PairRoomConfig:
        {
            return [RoomstateModel class];
        }
            break;
            
        case RoomCloseResult:
        {
            return [RoomEndModel class];
        }
            break;
